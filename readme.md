...
```
$ sudo ./setup.sh -t V23.0 -d mydomain.com -e myemail@example.com
```
...
```
$ sudo ./setup.sh -sft V23.0 -d mydomain.com -e myemail@example.com
```
