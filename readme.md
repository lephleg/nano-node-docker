...
```
$ sudo ./setup.sh -t V27.1 -d mydomain.com -e myemail@example.com
```
...
```
$ sudo ./setup.sh -sft V27.1 -d mydomain.com -e myemail@example.com
```
